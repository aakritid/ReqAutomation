...
$password = "pari123#"; // and it's password
$db_name = "purchasereq"; // db name
$tbl_name = "requistion"; // table name of the selected db


$conn = new mysqli($host, $user, $password,"purchasereq");
...
$data="";
for ($i = 0; $i < $fields; $i++) {
    $col_title .= '<Cell ss:StyleID="2"><Data ss:Type="String">'.$export->fetch_field_direct($i)->name.'</Data></Cell>';
}
